...
def custom_score(game, player):
    ...
    return float(num_my_moves - (2 * num_opponent_moves))
...
def custom_score_2(game, player):
    ...
    distance = distance_between_players(game, player, game.get_opponent(player))
    return float((num_my_moves + distance) - num_opponent_moves)
...
def distance_between_players(game, player, opponent):
    player_location = game.get_player_location(player)
    opp_location = game.get_player_location(opponent)
    x_distance = math.pow(abs(player_location[0] - opp_location[0]), 2)
    y_distance = math.pow(abs(player_location[1] - opp_location[1]), 2)
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        v, op_move = self.max_value_alphabeta(game, depth, alpha, beta)
    ...
    def min_value_alphabeta(self, game, depth, alpha, beta):
        ...
        op_move = -1, -1
        if depth == 0:
            return self.score(game, self), op_move
        for legal_move in game.get_legal_moves():
            value, _ = self.max_value_alphabeta(game.forecast_move(legal_move), depth-1, alpha, beta)
            if value < v:
                v = value
                op_move = legal_move
            if v <= alpha:
    ...
    def max_value_alphabeta(self, game, depth, alpha, beta):
        ...
        if depth == 0:
            return self.score(game, self), op_move
        for legal_move in game.get_legal_moves():
            value, _ = self.min_value_alphabeta(game.forecast_move(legal_move), depth - 1, alpha, beta)
            if value > v:
                v = value
                op_move = legal_move
            if v >= beta:
